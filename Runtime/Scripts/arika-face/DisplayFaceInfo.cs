...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class DisplayFaceInfo : MonoBehaviour
    {
        ...
        public string faceInfoText
        {
            get => m_FaceInfoText.text;
            set => m_FaceInfoText.text = value;
        }
        ...
        {
            get => m_InstructionsText.text;
            set => m_InstructionsText.text = value;
        }

        [SerializeField]
        [Tooltip("The Text to display instructions to the user that face tracking is not supported")]
        TextMeshProUGUI m_DistanceText;

        public string distanceText
        {
            get => m_DistanceText.text;
            set => m_DistanceText.text = value;
        }
        ...
        void Update()
        {
            ...
            if (m_FaceControlledObject)
            {
                ...
                m_DistanceText.text = Vector3.Distance(m_FaceControlledObject.transform.position, m_CameraManager.transform.position).ToString();
            }
