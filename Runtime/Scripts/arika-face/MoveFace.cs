...
namespace com.vwds.arika.face
{
    public class MoveFace : MonoBehaviour
    {
        ...
        private float speed;
        private FaceTrackingToAvatar faceTrackingToAvatar;
        private Vector3 AvatarPositionFromPhone;
        void Start()
        {
            currentFrame = 0;
            ...
            faceTrackingToAvatar = GetComponent<FaceTrackingToAvatar>();
        ...
        void Update()
        {
            ...
            else
            {
                ...
                AvatarPositionFromPhone = new Vector3(faceTrackingToAvatar.FaceObject.transform.position.x, ARWorldBehavior.Instance.transform.position.y, faceTrackingToAvatar.FaceObject.transform.position.z);
                transform.position = AvatarPositionFromPhone;
